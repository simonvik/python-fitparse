...
########## EXPORTED PROFILE FROM SPREADSHEET AT 2014-02-03 17:47:18 ##########
########### PARSED 60 TYPES (639 VALUES), 39 MESSAGES (479 FIELDS) ###########
...
MESSAGE_TYPES = {
    ...
    21: MessageType(
        ...
        fields={
            ...
            7: Field(  # Do not use.  Placeholder for sport_point subfield components
                name='score',
                type=BASE_TYPES[0x84],  # uint16
                def_num=7,
            ),
            8: Field(  # Do not use.  Placeholder for sport_point subfield components
                name='opponent_score',
                type=BASE_TYPES[0x84],  # uint16
                def_num=8,
            ),
